VENUE_TEMPLATES = {
	...
	'Bar': {'Bar1': 'For some reason, {name} went behind the bar, {0}. This really pissed off the bouncers.'
			...
			'{name} screamed "gets you hands off me, my fathers a lawyer!" and {1}. {name}\'s father is not a lawyer.',
			...
			' wasn\'t out there dancing, {subj_pronoun} just {1}. I had grab {name} by the shirt and pull {subj_pronoun} away or people were going to think {subj_pronoun} was insane. ',
			...
			'Bar5':' For some reason {name} was having a great time at the bar even though {subj_pronoun} stepped in dog excriment on the way to the bar. {name} was talking to everyone and people seemed to enjojy {obj_pronoun} conpany.'
			' However, people began to notice the smell coming off {name}\'s shoe. {name} had got nervous and {0}. This made the situation worse as people began to verablly point out how bad'
			' {name} smelled.  {subj_pronoun} spent the next hour or so cleaning off {obj_pronoun} shoe. By the time {name} left the bathroom the bar was closing. As we left there a NUMBER_GROUPING'
			...
			' for being a loose cannon. One time we went out, {name} got thrown out of the Bar because'
			...
			' next time {name} is coming out with us I might rething being the designated driver.' ,

			'Bar8':' Where do I begin with {name}. {name} had just recently broken up with {obj_pronoun}'
			' significant other so I knew tonight {name} would be a wildcard.  {name} started off the'
			' night by "flirting" with the bartenter, and by flirting I mean {subj_pronoun} {0}. Following that,'
