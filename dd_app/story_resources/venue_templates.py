VENUE_TEMPLATES = {
	...
	'Bar': {'Bar1': 'For some reason, {name} went behind the bar, {0}. This really pissed off the bouncers.'
			...
			'Bar5':' I knew {name} was going to be a problem when {subj_pronoun} {0}. Following that {name} {1}. {subj_pronoun} starting to become "that guy" at the bar no one wanted to be around. '
